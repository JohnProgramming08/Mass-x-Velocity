...
def join(clicked):
	...
	if not log_in_form.validate_on_submit() and not sign_up_form.validate_on_submit():
		return render_template("join.html", clicked=clicked, sign_up_form=sign_up_form, log_in_form=log_in_form, log_in_error="", sign_up_error="")
	...
	if "sign_up" in request.form and sign_up_form.validate_on_submit():
		...
		if type(id) is not int:
			return render_template("join.html", clicked=clicked, sign_up_form=sign_up_form, log_in_form=log_in_form, log_in_error="", sign_up_error=id)
